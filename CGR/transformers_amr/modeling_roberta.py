...
from transformers_amr.modeling_bert import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class RobertaEmbeddings(BertEmbeddings):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None, node_ids=None, node_adjs=None):
...
class RobertaModel(BertModel):
    ...
    def __init__(self, config, model_kwargs):
        ...
        self.embeddings = RobertaEmbeddings(config, model_kwargs)
        self.init_weights()
...
class RobertaForMultipleChoice(BertPreTrainedModel):
    ...
    def __init__(self, config, **model_kwargs):
        ...
        self.roberta = RobertaModel(config, model_kwargs)
